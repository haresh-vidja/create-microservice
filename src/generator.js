...
function createServicePackageJson(context) {
  ...
  const packageJson = {
    ...
    private: true,
    type: "module",
    description: `${context.displayName} microservice generated by microsvc-template.`,
    scripts: {
...
Generated with [microsvc-template](https://www.npmjs.com/package/microsvc-template).
