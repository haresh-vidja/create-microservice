...
function createServicePackageJson(context) {
  ...
  const packageJson = {
    ...
    private: true,
    type: "module",
    description: `${context.displayName} microservice generated by create-microservice.`,
    scripts: {
...
Generated with [create-microservice](https://www.npmjs.com/package/create-microservice).
